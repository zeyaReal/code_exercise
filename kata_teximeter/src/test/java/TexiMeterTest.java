...
public class TexiMeterTest {
    ...
    @Test
    public void test_fareForDistanceAndWaitingMinutes_should_return_18_25_when_distance_is_9_0_kilometer_and_waiting_4_minutes() throws Exception {
    ...
    public void test_roundFareForDistanceAndWaitingMinutes_should_return_18_when_distance_is_9_0_kilometer_and_waiting_4_minutes() throws Exception {
        assertThat(texiMeter.roundFareForDistanceAndWaitingMinutes(9.0f, 4), is(18));
    }
    ...
    public void test_roundFareForDistanceAndWaitingMinutes_should_return_18_when_distance_is_9_0_kilometer_and_waiting_2_minutes() throws Exception {
        assertThat(texiMeter.roundFareForDistanceAndWaitingMinutes(9.0f, 2), is(18));
    }
}
